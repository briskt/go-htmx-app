<?php
 ...
 class m991231_235959_seeds extends Migration
 {
     ...
     public function safeUp()
     {
         ...
         $users = [
             [1, '10001', 'john_doe', '10001@example.com', 'no', $later, $later, $later, 'mgr@example.com', '', '', $now, $now, 'yes', 'no', '06974223-d832-4938-8923-5c598e4446b3'],
         ];
         ...
         $passwords = [1, 1, $now, $nextYear, $nextYear, password_hash('boot promote elegant bottle', PASSWORD_BCRYPT)];
